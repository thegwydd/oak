...
/**
* formats a string into a std::string as sprintf
* @return	converted string
*/
std::string string_format(const std::string fmt, ...);

/**
* formats a string into a std::wstring as sprintf
* @return	converted string
*/
std::wstring wstring_format(const std::wstring fmt, ...);

/**
* formats a vector of bytes into hex string
* @return	converted string
*/
std::string bytes_to_hex_string(const std::vector<uint8_t> & buffer, int max = -1, bool trailing_dots = false);

/**
* formats a vector of bytes into hex string
* @return	converted string
*/
std::string bytes_to_hex_string(const uint8_t * data, size_t len, int max = -1, bool trailing_dots = false);

/**
* formats a vector of bytes into hex string
* @return	converted string
*/
std::wstring bytes_to_hex_wstring(const std::vector<uint8_t> & buffer, int max = -1, bool trailing_dots = false);

/**
* formats a vector of bytes into hex string
* @return	converted string
*/
std::wstring bytes_to_hex_wstring(const uint8_t * data, size_t len, int max = -1, bool trailing_dots = false);

/**
* converts a hex string to bytes vector
* @return	number of converted bytes
*/
std::size_t hex_string_to_bytes(std::string source, std::vector<uint8_t> & buffer);

/**
* converts a hex wstring to bytes vector
* @return	number of converted bytes
*/
